...
# *************************************
# * Version: v0.54+0.1i (beta release)*
# *************************************
...
#
# -- Preliminary support for other outer-totalistic rules, including
#    detection and classification of various types of infinite growth.
#
...
class Soup:
    ...
    commonnames = {"xp2_7": ("blinker", 0),
                   ...
                   "xq2_1fcgcf1": ("c/2 #1", 9),
                   "xq2_0ki313ikz12": ("c/2 #2", 16),
                   "xq2_2l4x4l2zw13231": ("c/2 #3", 16),
                   "xq2_1feice0ecief1": ("c/2 #4", 27),
                   "xq2_523a6m8zxl5dgz526233": ("c/2 #5", 31),
                   "xq4_v91e0e19v": ("2c/4 #1", 20),
                   "xq5_227x4ee": ("double t", 8),
                   "xq5_72202a0ew8s": ("trans triple-t", 20),
                   "xq5_72202a0ew27": ("cis triple-t", 20),
                   "xq6_4rrwe465": ("2c/6 #1", 17),
                   "xq4_0g8e71f6cz707": ("c/4 #1", 28),
                   "xp4_69f": ("cap", 0),
                   "xp4_0diczpi62ac": ("cap variant I", 27),
                   "xp4_39c8a6z0f96zc93156": ("cap variant II", 34),
                   "xp4_9f0ciu": ("oscillating cap on table", 22),
                   "xp4_69f0ciu": ("oscillating cap on cap", 24),
...
#ALGO REF!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        for i in xrange(gsize * gsize):
            ...
            # seed with the index:
            g.putcells(hashsoup(root + str(pos + i), sym), 0, 0)
...
#ALGO REF!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    def save_progress(self, numsoups, root, symmetry):
    ...
    def display_census(self, numsoups, root, symmetry1, symmetry2):
        ...
        results += "<p>Census results after processing " + str(numsoups) + " soups (seed = " + root + ", symmetry = " + symmetry1 + "):\n"
        ...
        for objname, count in tlist:
            ...
            if objname in self.alloccur:
                results += "&nbsp;"
                for soup in self.alloccur[objname]:
                    results += self.save_soup(root, soup, symmetry2) 
                    results += "&nbsp;"
            results += "</td></tr>\n"
        results += "</table>\n</center>\n"
        ...
        for soupnum, score in ilist[:50]:
            results += "<tr><td>&nbsp;"
            results += self.save_soup(root, soupnum, symmetry2)
